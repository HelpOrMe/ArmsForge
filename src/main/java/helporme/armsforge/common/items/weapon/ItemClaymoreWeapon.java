...
public class ItemClaymoreWeapon extends ItemModelWeapon implements ITwoHandedWeapon
{
    public ItemClaymoreWeapon()
    {
        super("Claymore", ToolMaterial.IRON, "TwohandedAtlas");
    }
}
